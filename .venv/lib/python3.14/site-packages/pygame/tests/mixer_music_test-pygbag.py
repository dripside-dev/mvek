...
class MixerMusicModuleTest(unittest.TestCase):
    ...
    def test_load_xm(self):
        "|tags:music|"
        self.music_load("surfonasinewave.ogg")
    ...
    def test_load_unicode(self):
        ...
        with TemporaryDirectory() as tmpdir:
            temp_file = os.path.join(tmpdir, "你好.ogg")
    ...
    def test_queue_xm(self):
        ...
        |tags:music|
        """
        filename = example_path(os.path.join("data", "surfonasinewave.ogg"))
        pygame.mixer.music.queue(filename)
    ...
    def test_music_get_metadata(self):
        ...
        path = os.path.join(file_dir, "metadata.ogg")
