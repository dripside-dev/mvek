...
CHARACTERS = {
    "student": {
        "name": "СТУДЕНТ",
        "descr": "Базовый: 3 сердца, средние статы",
    ...
    "magda": {
        "name": "МАГДА",
        "descr": "Отличница: +2 сердца, чуть медленнее",
        "max_love": 10, "speed": 2.6, "damage": 0.8,
        "fire_rate": 2.5, "luck": 0, "soul": 0,
        "starts_with": [],
    },
    "botan": {
        "name": "БОТАН",
        "descr": "Хилый, но Очки уже на нём (homing)",
        "max_love": 4, "speed": 2.6, "damage": 1.0,
        "fire_rate": 3.2, "luck": 2, "soul": 0,
        "starts_with": ["Очки ботаника"],
    },
    "sportsman": {
        "name": "СПОРТСМЕН",
        "descr": "Быстрый и крепкий, но стреляет редко",
        "max_love": 8, "speed": 4.0, "damage": 1.4,
        "fire_rate": 1.8, "luck": 0, "soul": 0,
        "starts_with": [],
    },
    "starosta": {
        "name": "СТАРОСТА",
        "descr": "С зачёткой: 2 синих сердца + ключ-доступ",
        "max_love": 6, "speed": 2.8, "damage": 1.0,
        "fire_rate": 2.5, "luck": 1, "soul": 2,
        "starts_with": [],
    },
}
